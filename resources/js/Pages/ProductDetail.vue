            ...
            >
                ...
                <div class="flex flex-col justify-start py-6">
                    ...
                    <div class="flex items-center gap-4 mb-6">
                        <p class="text-xl sm:text-2xl font-bold">Rp 399.000</p>
                        <div
                    ...
                    <div class="flex flex-col gap-6">
                        ...
                        <div>
                            <h3
                                class="text-gray-700 font-semibold mb-2 text-lg"
                            >
                                Rincian
                            </h3>
                            <div
                        ...
                        >
                            <button
                                class="px-6 py-3 bg-primary rounded-lg hover:bg-primary-dark transition duration-200 w-full sm:w-auto flex items-center justify-center gap-2"
                            >
                                <svg
                            ...
                            <button
                                class="px-6 py-3 bg-green-600 rounded-lg hover:bg-green-700 transition duration-200 w-full sm:w-auto flex items-center justify-center gap-2"
                            >
                                <svg
                                    xmlns="http://www.w3.org/2000/svg"
                                    width="24"
