...
<template>
    <div
        class="flex items-center justify-center gap-2 cursor-pointer px-3.5 py-3 rounded-lg hover:bg-gray-50 outline outline-1 -outline-offset-1 outline-gray-400 min-w-[60px]"
        :class="{
